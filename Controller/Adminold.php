...
class Admin extends Blog
{
    ...
    public function editPost()
    {
      ...
      if (isset($_POST['edit_submit']))
      {
        ...
        {
          $this->oUtil->sErrMsg = 'Tous les champs doivent être remplis 1.';
        }
        else
        {
          ...
          $aData = array('animal_id' => $_GET['id'], 'nom' => $_POST['nom'], 'photo' => $_POST['photo'], 'dateNaissance' => $_POST['dateNaissance']);
    ...
    public function add()
    {
      ...
      if (isset($_POST['add_submit']))
      {
          ...
          else
          {
            ...
            $aData = array('nom' => $_POST['nom'], 'photo', 'dateNaissance');
